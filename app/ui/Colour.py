...
class ColourScheme:
    ...
    def __init__(self, terminal, theme='default'):
        if theme in self.themes:
            ...
            self.normal = getattr(terminal, 'normal')
        else:
...
if __name__ == '__main__':
    ...
    print(f"2: {theme_2.text}This is another example with a different theme.{theme_2.normal}")
    print(f"3: {theme_3.board_edges}Garbage text. {theme_3.white_squares} ♛ \
